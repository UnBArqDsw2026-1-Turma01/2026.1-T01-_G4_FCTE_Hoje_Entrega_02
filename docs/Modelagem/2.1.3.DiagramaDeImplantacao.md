...
- **Aplicação Backend:** Artefato implantado no servidor web. Contém a lógica do sistema, incluindo gerenciamento de usuários, conteúdos, notificações e preferências.
...
- **API Externa (Opcional):** Representa serviços de terceiros que podem ser integrados ao sistema, como serviços de autenticação, envio de e-mails, uso do Google Agenda ou notificações push.
