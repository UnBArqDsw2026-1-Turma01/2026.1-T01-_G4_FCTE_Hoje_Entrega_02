...
| Aluno  | Participação|
| -- | -- |
|  Arthur Guilherme Aquino Santos |  Contribuição na documentação e realização do **Diagrama de Estado de Filtrar Conteúdo** e do **Diagrama de Estado de Atualizar Perfil** |
|  Tiago Lemes Teixeira | Contribuição na documentação e realização do **Diagrama de Estado de Login/Cadastro** e do **Diagrama de Estado de Notificação** |
|  Vilmar José Fagundes  | Criação e contribuição na documentação e realização do **Diagrama de Estado de Navegação Principal**  |
...
<p align="center"><strong>Figura 3: Diagrama de Estado de Filtrar Conteúdo</strong></p>
...
Este diagrama descreve o comportamento do sistema ao filtrar conteudos com base em critérios informados pelo usuário.
...
<p align="center"><strong>Figura 4: Diagrama de Estado de Atualizar Perfil</strong></p>
...
<p align="center"><strong>Figura 5: Diagrama de Estado de Navegação Principal</strong></p>
