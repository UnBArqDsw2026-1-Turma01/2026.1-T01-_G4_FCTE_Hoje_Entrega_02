...
- Analise da informações adicionais que descrevem a interação com o sistema: Foram analisadas a lista de requisitos e os diagramas para compreender a funcionalidade do sistema;
